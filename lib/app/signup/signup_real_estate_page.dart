...
class SignupRealEstatePage extends StatefulWidget {
  const SignupRealEstatePage({super.key});

  @override
  State<SignupRealEstatePage> createState() => _SignupRealEstatePageState();
}

class _SignupRealEstatePageState extends State<SignupRealEstatePage> {
